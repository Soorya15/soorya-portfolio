    ...
    <nav className="bg-black text-white px-8 md:px-16 lg:px-24 fixed w-full z-50 shadow-md">
      <div className="container mx-auto py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6 items-center">
          {navLinks}
          <a href="#contact">
            <button className="bg-gradient-to-r from-blue-500 to-purple-800 text-white transform transition-transform duration-300 hover:scale-105 px-4 py-2 rounded-full">
              Connect Me
            </button>
          </a>
        </div>
